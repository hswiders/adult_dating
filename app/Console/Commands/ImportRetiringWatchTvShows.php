...
class ImportRetiringWatchTvShows extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ImportRetiringWatchTvShows:cron';
      ...
      $ApiKey = new ApiKey();
			...
			foreach($providers as $provider){
				...
				if(isset($responce->results) && !empty($responce->results)){
					...
					RetiringModel::where('media_type','tv')->where('provider',$provider)->delete();
