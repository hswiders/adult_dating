                ...
                <table border="0" cellpadding="0" cellspacing="10" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center" style="text-align: center;" valign="middle"><a style="font-family:\'Ubuntu\',sans-serif;color:#ff3000;font-weight:300;display:block;letter-spacing:-1.5px;text-decoration:none;margin-top:2px" href="#">{{env('APP_LOGO_NAME')}}</a></td>
